...
<c:if test="${skuList.size() > 0}">
    <table border="1" bordercolor="#a0c6e5" align="center" style="border-collapse:collapse;width: 100%;table-layout: fixed">
        ...
        <c:forEach items="${skuList}" var="sku">
            ...
            <tr>
                ...
                <td>
                    <button value="${sku.skuId}" onclick="editSku(this.value)">修改</button>
                </td>
            </tr>
        </c:forEach>
    </table>
