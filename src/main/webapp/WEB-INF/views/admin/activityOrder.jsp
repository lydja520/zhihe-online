        ...
        $(function () {
            $('#dg').datagrid({
                ...
                columns: [[
                    ...
                    {
                      field:'merchant.merchName',title:'订单所属商家',width:100,align:'center',
                        formatter:function(value,rows,index){
...
//                    {
//                        field: 'activity.activityPromoter.merchName', width: 100, title: '活动发起商', align: 'center',
//                        formatter: function (value, rows, index) {
//                            return rows.activity.activityPromoter.merchName;
//                        }
//                    },
//                    {
//                        field: 'activity.activityPromoter.merchTell', width: 100, title: '发起商联系电话', align: 'center',
//                        formatter: function (value, rows, index) {
//                            return rows.activity.activityPromoter.merchTell;
//                        }
//                    },
                    {
                        field: 'buyerAccount', title: '支付方支付账号', width: 100, align: 'center'
                    },
                    {
                        field: 'sellerAccount', title: '收款方支付宝账号', width: 100, align: 'center'
                    },
                    {
                        field: 'totalMoney', title: '订单金额', width: 100, align: 'center',
                        formatter: function (value, rows, index) {
                            return value + "元";
                        }
                    },
