...
//                                console.log("ssss");
            ...
            function updateMerchPermit(permit) {
                ...
                $.messager.confirm('提示', '确定要进行此操作吗？', function (r) {
                    if (r) {
                        ...
                        json.permitState = permit;
                        request({
                            data: json,
                            url: '${basePath}/admin/api/adminEdit/adminPermitEdit',
                            success: function (data) {
                                if (data.success) {
                                    $.messager.show({
                                        title: '提示',
            ...
            /*==========启用或禁用按钮============*/
            $('#edit-permit-true').click(function () {
                updateMerchPermit(true);
            })
            $('#edit-permit-false').click(function () {
...
<div id="grid_toolbar" class="toolbar-container">
    ...
    <a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" id="edit-permit-true">启用</a>
    <a class="easyui-linkbutton" data-options="iconCls:'icon-remove'" id="edit-permit-false">禁用</a>&nbsp;&nbsp;
